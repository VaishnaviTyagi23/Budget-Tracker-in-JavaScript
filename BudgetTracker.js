    ...
    static entryHtml() {
        return `
            <tr>
                ...
                <td>
                    <input type="number" class="input input-amount" placeholder="Enter amount">
                    <span class="error-message" style="display:none; color:red; font-size:12px;">Amount is required</span>
                </td>
                <td>
